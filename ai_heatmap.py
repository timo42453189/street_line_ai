...
#model = tf.keras.models.load_model('use_models/heatmap_model_new/model_15_epochs_19000_2_lr_scedule.h5')
model = compile_model(model)
early_stopping = EarlyStoppingByLoss(monitor='val_loss', value=0.04, verbose=1)
model = train(model, x_train, y_train, x_val, y_val, 10, early_stopping)
model.save("use_models/heatmap_model_new/model_10_epochs_19000_2_lr_scedule.h5")